...
export const TRACK_DATA: TrackRow[] = [
  ...
  { id: 13, typeid1:'#0-17-1',typeid:'#0-17',type:'Stabilized Subgrade-L',geometry:'line',unitprice:15.00,totalprice:216000.00, color:'grey',unit:"SY" },
  { id: 14, typeid1:'#0-17-2',typeid:'#0-17',type:'Stabilized Subgrade-A',geometry:'polygon',unitprice:15.00,totalprice:0, color:'grey',unit:"SY" },
  { id: 15, typeid1:'#0-18-1',typeid:'#0-18',type:'Limerock Base-L',geometry:'line',unitprice:48.75,totalprice:737100.00,color:'grey',unit:"SY" },
  { id: 16,typeid1:'#0-18-2',typeid:'#0-18',type:'Limerock Base-A',geometry:'polygon',unitprice:48.75,totalprice:0,color:'grey',unit:"SY" },
  {id: 17, typeid1: '#0-19-1', typeid:'#0-19',type: 'Asphalt Pavement Restoration-L', geometry: 'line', unitprice: 31.00,totalprice:492156.00, color: 'grey', unit: "SY" },
  {id: 18,typeid1: '#0-19-2', typeid:'#0-19',type: 'Asphalt Pavement Restoration-A', geometry: 'polygon', unitprice: 31.00,totalprice:0, color: 'grey', unit: "SY" },
  { id: 19, typeid1: '#0-20-1', typeid:'#0-20',type: 'Mill and Resurface Asphalt Pavement-L', geometry: 'line', unitprice: 19.00, totalprice: 934800.00, color: 'grey', unit: "SY" },
  { id: 20,typeid1: '#0-20-2', typeid:'#0-20',type: 'Mill and Resurface Asphalt Pavement-A', geometry: 'polygon', unitprice: 19.00, totalprice: 0, color: 'grey', unit: "SY" },
