...
const schema = a.schema({
  ...
  Date: a
    .model({
      ...
      labor: a.integer(),
      prime2: a.string(),
      supervisor2: a.string(),
      labor2: a.integer(),
      subcontractor1: a.string(),
      supervisors1: a.string(),
      labors1: a.integer(),
      subcontractor2: a.string(),
      supervisors2: a.string(),
      labors2: a.integer(),
      subcontractor3: a.string(), 
      supervisors3: a.string(),
      labors3: a.integer(),
